...
struct Constants {
    ...
    static func getWeatherIconString(icon: String) -> String? {
        ...
        switch weatherIcon {
            ...
            case .brokenCloudsDay, .brokenCloudsNight, .overcastCloudsDay, .overcastCloudsNight: return "cloud.fill"
            ...
            .lightIntensityShowerRain, .showerRain, .heavyIntensityShowerRain, .raggedShowerRain: return "cloud.drizzle.fill"
            case .rainDay, .rainNight, .lightRain, .moderateRain, .heavyIntensityRain, .veryHeavyRain, .extremeRain: return "cloud.heavyrain.fill"
            case .freezingRain: return "cloud.sleet.fill"
            case .lightSnow, .snow, .heavySnow, .sleet, .lightShowerSleet, .showerSleet,
            .lightRainAndSnow, .rainAndSnow, .lightShowerSnow, .showerSnow, .heavyShowerSnow: return "cloud.snow.fill"
            case .mist, .smoke, .haze, .sandDustWhirls, .fog, .sand, .dust, .volcanicAsh, .squalls, .tornado: return "cloud.fog.fill"
